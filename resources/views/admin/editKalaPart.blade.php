                               ...
                               @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-end">
                                             <button type="submit" @if(hasPermission(Session::get( 'adminId'),'homePage' ) <1 ) disabled @endif class="btn btn-success btn-sm text-warning">ذخیره <i class="fa-light fa-save"></i></button>
                                        </div>
                                 </div>
                                      ...
                                      <table class="table table-bordered table-sm">
                                        <thead class="tableHeader">
                                            <tr>
                                                ...
                                                <th>
                                                    <button style="background-color:transparent;"  @if(hasPermission(Session::get( 'adminId'),'homePage' ) <1 ) disabled @endif class='priority' id="down" type="button" value="down" ><i class="fa-solid fa-circle-chevron-down fa-sm" style=''></i></button> &nbsp;
                                                    <button style="background-color:transparent;"  @if(hasPermission(Session::get( 'adminId'),'homePage' ) <1 ) disabled @endif class='priority' id="top"  type="button" value="up" >  <i class="fa-solid fa-circle-chevron-up fa-sm" style=''></i></button>
                                                </th>
                                                <th>
