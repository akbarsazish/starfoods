...
<div class="container-fluid containerDiv">
                       ...
                       <div class="col-lg-12 p-2">
                         ...
                         <div class="row">
                            <div class="col-sm-8">
                                <div class="input-group input-group-sm mb-2">
                                    ...
                                    <input type="text"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="form-control form-control-sm" name=""   value="{{trim($customer->peopeladdress)}}" size="20" class="form-control" id="allKalaFirst">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="input-group input-group-sm mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                    ...
                                    <input class="form-control form-control-sm pr-0 mr-0"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif  type="text"  name="" id="allKalaFirst">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="input-group input-group-sm mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="input-group input-group-sm mb-2">
                                                ...
                                                <input type="text"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class=" col-sm-10 form-control form-control-sm"  name=""  id="province">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group input-group-sm mb-2">
                                                <span class="input-group-text" id="inputGroup-sizing-sm"> شهر    </span>
                                                <input type="text"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="col-sm-10 form-control form-control-sm"  name=""  id="city">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="input-group input-group-sm mb-2">
                                                <span class="input-group-text" id="inputGroup-sizing-sm"> کدپستی  </span>
                                                <input type="text"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="col-sm-12 form-control form-control-sm"  name=""  id="postalCode">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="input-group input-group-sm mb-2">
                                                <span class="input-group-text" id="inputGroup-sizing-sm"> آدرس  </span>
                                                <input type="text"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="col-sm-10 form-control form-control-sm m-0 p-0"  name=""  id="address">
                                            </div>
                                        </div>
                                    </div>
                            </fieldset>
                    ...
                    <div class="row " style="width:98%; padding:0 1% 2% 0%">
                                <div class="col-sm-2">
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <input class="form-control form-control-sm"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif type="text"  name="" id="allKalaFirst">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="input-group input-group-sm mb-2">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group input-group-sm mb-2">
                                        <button class="btn btn-success text-warning"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif type="button" name="" id="allKalaFirst">ثبت مکان</button>
                                    </div>
                                </div>
                           </div>
                ...
                <div class="row c-checkout rounded-3 tab-pane" id="userLoginInfo" style="width:99%; margin:0 auto; padding:1% 0% 0% 0%">
                    ...
                    <div class="row" style="width:98%; padding:0 1% 2% 0%">
                        <div class="row">
                                <div class="col-sm-2">
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm accessInfo"   @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif   value="{{trim($customer->userName)}}" name="userName" size="20" id="userName">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="input-group input-group-sm mb-2">
                                        <span class="input-group-text" id="inputGroup-sizing-sm"> رمز عبور  </span>
                                        <input type="text" class="form-control form-control-sm accessInfo"  name=""  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif  value="{{$customer->customerPss}}" size="20" id="EqtisadiCode">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm accessInfo"   @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif name=""  value="{{number_format($customer->minimumFactorPrice)}}" size="20" id="FactorMinPrice">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="input-group input-group-sm mb-2">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">اجازه داده چندین موبایل  </span>
                                        <input type="number" class="form-control form-control-sm accessInfo"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif value="{{$customer->manyMobile}}" class="form-check-input" id="ManyMobile">
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-2">
                                    <div class="form-check ">
                                    <span> <input type="checkbox" name=""  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="form-check-input float-start p-1 accessInfo" @if($customer->manyMobile>0) checked @else @endif id="ForceExit"></span>
                            ...
                            <div class="col-sm-2">
                                <div class="form-check ">
                                <span><input type="checkbox" name=""   @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif  class="form-check-input float-start p-1 accessInfo"  @if($customer->exitButtonAllowance==1) checked @else @endif class="form-check-input" id="ExitButtonShow"></span>
                                    <label class="form-check-label ms-4" for="flexCheckDefault">
                                    اجازه دکمه خروج
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-check ">
                                <span> <input type="checkbox" name=""  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif class="form-check-input float-start p-1 accessInfo"  @if($customer->countLogin>0) checked @else @endif class="form-check-input" id="OnlineStatus" ></span>
                                    <label class="form-check-label ms-4" for="flexCheckDefault">
                                        وضعیت آنلاین 
                                    </label>
                                </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-check ">
                                <span><input type="checkbox"  class="form-check-input float-start p-1 accessInfo" @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif name="" @if($customer->pardakhtLive==1) checked @else @endif  class="form-check-input" id="PardakhtLive"></span>
                                    <label class="form-check-label ms-4" for="flexCheckDefault">
                            ...
                            <div class="col-sm-2">
                                <div class="form-check ">
                                   <span><input type="checkbox" class="form-check-input float-start p-1 accessInfo"  @if(hasPermission(Session::get( 'adminId'),'customers' ) < 1) disabled @endif name="officialInfo" @if($customer->officialInfo==1) checked @else  @endif class="form-check-input" id="officialInfo"></span>
                                    <label class="form-check-label ms-4" for="flexCheckDefault">
                                        ویرایش معلومات رسمی 
                                    </label>
                                </div>
    ...
    <script>
        window.onload = function() {
            ...
            // used for adding kala to subgroups

            $("#addKala").click(function() {
                //main group id
                //sub group id
                //kala id
                // mainGroupId=$('.mainGroupId:checked').val().split('_')[0]
                var subGroupID = [];
