...
<html lang='en'>
	<head>
		...
		<link rel="stylesheet" href="{{url('/resources/assets/hextris/style/fa/css/font-awesome.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{url('/resources/assets/hextris/style/style.css')}}">
		<script type='text/javascript' src="{{ url('vendor/hammer.min.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/vendor/js.cookie.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/vendor/jsonfn.min.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/vendor/keypress.min.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/vendor/jquery.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/save-state.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/view.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/wavegen.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/math.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/Block.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/Hex.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/Text.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/comboTimer.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/checking.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/update.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/render.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/input.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/main.js')}}"></script>
		<script type='text/javascript' src="{{url('/resources/assets/hextris/js/initialization.js')}}"></script>
		<script src="{{url('/resources/assets/hextris/vendor/sweet-alert.min.js')}}"></script>
		<link rel="stylesheet" href="{{url('/resources/assets/hextris/style/rrssb.css')}}"/>
	</head>
	<body>
		...
		<img id="openSideBar" class='helpText' src="{{url('/resources/assets/hextris/images/btn_help.svg')}}"/>
		...
		<script type="text/javascript" src="{{url('/resources/assets/hextris/vendor/rrssb.min.js')}}"></script>
	</body>
</html>
