...
<tr onclick="changeMainGroupStuff(this)">                                             <tr>
    <td>` + (i + 1) + `</td>
            ...
            answer[0].forEach((element,index)=>{
                $('#cutomerBody').append(
                    `<tr class="subGroupList1 maserTr" onclick="checkCheckBox(this,event)">
                        ...
                        <td>` + element.PCode + `</td>
                        <td>` + element.Name+ `</td>
                        <td style="width:180px">` + element.peopeladdress+ `</td>
...
success: function(answer) {
    ...
    for (var i = 0; i <= data.length - 1; i++) {
        ...
        <td>` + (i + 1) + `</td>
        <td>` + data[i].title + `</td>
        <td><input class="subGroupId"   name="subGroupId[]" value="` + data[i].id + `_` + data[i].selfGroupId + `_` +
            data[i].percentTakhf + `_` + data[i].title +
            `" type="radio" id="flexCheckChecked` + i + `"></td></tr>`);
    }
    if (data.length > 0) {
...
success: function(arrayed_result) {
    ...
    <tr  onclick="checkCheckBox(this,event)">
        ...
        <td>` + arrayed_result[i].GoodName + `</td>
        <td>
        <input class="form-check-input" name="kalaListOfGroupIds[]" type="checkbox" value="` +
            arrayed_result[i].GoodSn + `_` + arrayed_result[i]
            .GoodName + `" id="kalaId">
        </td>
    </tr>
...
<img src="/resources/assets/images/boy.png"
