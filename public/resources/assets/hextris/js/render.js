...
function renderBeginningText() {
	...
	if (/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		mob = true;
		input_text = "روی صفحه نمایش به چپ و راست ضربه بزنید"
		action_text = "اضلاع برای چرخاندن شش ضلعی"
		score_text = "تطبیق 3+ بلوک برای گلزنی"
		fontSize = 35
	} else {
		mob = false
		input_text = "از کلیدهای جهت دار راست و چپ استفاده کنید"
		action_text = "برای چرخاندن شش ضلعی"
		score_text = "مطابقت با 3 بلوک به گل!"
		fontSize = 27
	}
